...
\addtolength{\intextsep}{-3pt} % space left on top and bottom of an in-text float.
\addtolength{\textfloatsep}{-2pt} % 12pt  % space between last top float or first bottom float and the text.
